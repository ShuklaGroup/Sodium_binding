...
sodium_z_dist = pickle.load(open('./CB2_sodium_ion_z_dist.pkl','rb'))

orthosteric_residue_movement = pickle.load(open('./CB2_orthosteric_residue_movement.pkl','rb'))
...
axs.set_ylim([2,12])                                                                            #min and max limit of y-axis

axs.set_xticks(range(int(-10),int(30)+1,10))                                                    #x-axis ticks
axs.set_xticklabels(range(int(-10),int(60)+1,10))                                               #y-axis ticks

axs.set_yticks(range(int(2),int(12)+1,2))                                                       #x-axis tick size
axs.set_yticklabels(range(int(2),int(12)+1,2))                                                  #y-axis tick size

plt.xlabel('z' + ' (\AA)', **hfont,fontsize=30)                                                 #x-axis label
plt.ylabel('F87$^{2.57}$-V113$^{3.32}$ distance' + ' (\AA)', **hfont,fontsize=30)               #y-axis label 
