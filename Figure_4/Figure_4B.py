...
tyr_tyr_distance = pickle.load(open('./CB2_tyr_tyr_distance.pkl','rb'))

asp_asn_distance = pickle.load(open('./CB2_asp_asn_distance.pkl','rb'))
...
plt.xlabel('Y70$^{2.40}$-Y299$^{7.53}$ distance' + ' (\AA)', **hfont,fontsize=30)              #x-axis label
plt.ylabel('D80$^{2.50}$-N295$^{7.49}$ distance' + ' (\AA)', **hfont,fontsize=30)              #y-axis label 
