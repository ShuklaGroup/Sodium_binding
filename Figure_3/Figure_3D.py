...
for j in range(200):        #CB1
    CB1_fractions = pickle.load(open("../CB1_bootstraping/bt_80_" + str(j) +"_ECL1_fraction.pkl",'rb'))
...
for j in range(200):        #CB2
    CB2_fractions = pickle.load(open("../CB2_bootstraping/bt_80_" + str(j) +"_ECL1_fraction.pkl",'rb'))
...
plt.xticks([1, 2], ['CB$_1$ (D184$^{ECL1}$)', 'CB$_2$ (D101$^{ECL1}$)'])                  #x-axis label
