...
glu_thr_distance = pickle.load(open('./CB1_glu_thr_distance.pkl','rb'))

glu_chi2 = pickle.load(open('./CB1_glu_chi2.pkl','rb'))
...
plt.ylabel('E133$^{1.49} \chi_2$ angle', **hfont,fontsize=30)                                  #y-axis label
plt.xlabel('E133$^{1.49}$-T391$^{7.47}$ distance' + ' (\AA)', **hfont,fontsize=30)              #x-axis label 
